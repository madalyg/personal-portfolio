...
export function ProjectCard({
  ...
  return (
    ...
    >
      {thumbnail && (
        <div className="relative -m-6 mb-0 aspect-[16/10] w-[calc(100%+3rem)] overflow-hidden border-b border-zinc-200 dark:border-zinc-800 sm:-m-7 sm:mb-0 sm:w-[calc(100%+3.5rem)]">
          <Image
            src={thumbnail}
            alt={project.title}
            fill
      ...
      <div className="mt-auto flex flex-wrap gap-2 border-t border-zinc-200 pt-4 dark:border-zinc-800">
