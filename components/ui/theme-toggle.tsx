...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="relative flex h-8 w-8 items-center justify-center rounded-sm border border-zinc-200 text-zinc-700 transition-colors duration-200 hover:border-accent/40 hover:text-accent dark:border-zinc-600 dark:text-zinc-200 dark:hover:border-accent/50 dark:hover:text-accent"
    >
      <Sun
