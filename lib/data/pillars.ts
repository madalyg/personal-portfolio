...
export const pillars: Pillar[] = [
  ...
  },
  {
    ...
    description:
      "Physics research applying machine learning and numerical methods to astrophysics and optical sensor data, from supermassive black holes to quantum information.",
    skills: [
