...
export const researchPapers: ResearchPaper[] = [
  {
    ...
    summary:
      "Built an automated Python pipeline that isolates the fastest known extremely high velocity quasar outflows (surrounding supermassive black holes, at > 20% the speed of light) from Lyman-alpha forest spectral data contamination by exploiting physical variability timescales across multi-epoch SDSS spectra. Designed a pipeline integrating a redshift-invariant autoencoder (SpenderQ) as a fallback for reconstructing the intrinsic quasar continuum, scaled to process thousands of spectra at a time. Successfully used this pipeline to identify the second-fastest outflow in the universe. Awarded a fully-funded travel grant from NASA-SURA, sponsored by the NASA Goddard Space Flight Center, to present at the 16th International Laser Interferometer Space Antenna Symposium.",
    date: "2025-11-01",
    ongoing: true,
    venue:
